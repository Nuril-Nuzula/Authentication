...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnLogout.setOnClickListener {
            ...
            dialog.setMessage("Yakin Deck ???")
            dialog.setPositiveButton("100% Yakin") {_,_ ->
                Snackbar.make(binding.root,"Berhasil Log Out", Snackbar.LENGTH_LONG).show()
            ...
            dialog.setNegativeButton("Gk Jadi") {listener, _ ->
                listener.dismiss()
            }
            dialog.show()
        }
